  ...
  return (
    <div className="flex flex-col gap-4 bg-gray-100 min-h-screen">
      ...
      <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9  w-full  pb-10 pt-4">
        {/* If still loading show skeleton otherwise show the content the user wants */}
        {loadingCity ? (
          <WeatherSkeleton />
        ) : (
          <>
                  ...
                  <div className="flex gap-10 sm:gap-16 overflow-x-auto w-full justify-between pr-3">
                    {data?.list.map((dat, index) => (
                      ...
                      >
                        ...
                        <p>
                          {convertKelvinToCelsius(dat?.main.temp ?? 0)}&deg;C
                        </p>
                      </div>
                    ))}
                  </div>
...
// Skeleton loading component whilst waiting for the data to show
